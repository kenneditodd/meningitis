...
```{r}
# read table
#immune.df <- read.delim2("../../refs/InnateDB_genes.txt")
# convert gene_name to enseml id
#immune.genes <- immune.df$name
#immune.avail <- rownames(dge) %in% immune.genes # investigate later
# subset dge object
#start <- dim(dge)[1]
#keep <- rownames(dge) %in% immune.genes
