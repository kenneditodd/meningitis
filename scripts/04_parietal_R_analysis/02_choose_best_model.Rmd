...
markers <- c("GFAP", "TTR", "VWF", "COL1A2", "C1QB", "KIT", "ITGAX", "SNAP25",
             "NES","MBP", "TNR", "ACTA2", "HBB", "MPZ","CD3E")
length(markers)
...
```{r CCA_heatmap}
# formula
form <- ~0 + group + sex + braak + thal + age_at_death + brain_wt +
  race + RIN + MPZ + TNR + KIT + C1QB + HBB +
  CD3E + VWF + ACTA2 + ITGAX + GFAP + TTR + MBP + SNAP25
...
form <- ~ (1|group) + (1|sex) + (1|thal) + 
  age_at_death + brain_wt + RIN + C1QB + MPZ + TNR + KIT + ACTA2 + HBB +
  GFAP + TTR + MBP + SNAP25
...
variables <- c("(1|braak)",
               ...
               "brain_wt",
               "RIN",
               "MPZ","TNR","KIT","COL1A2","C1QB","HBB","CD3E","VWF","ACTA2",
               "ITGAX","GFAP","TTR","MBP","SNAP25")
