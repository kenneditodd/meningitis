...
subtitle: "Differential Expression: group + sex + rin + snap25"
author: "Kennedi Todd"
date: "09/11/2023"
output:
  html_document:
...
```{r set_variables}
tissue <- "parietal"
folder <- paste0(tissue,"_1CPM_in_8_samples")
...
design <- model.matrix(~ 0 + group + sex + snap25)
colnames(design)[c(1,2)] <- c("control","meningitis")
